...
/*
|--------------------------------------------------------------------------
| SyntoraPHP Framework
|--------------------------------------------------------------------------
|
| SyntoraPHP is a fast, safe, and easy-to-use PHP framework designed for
...
|
| Features:
| - Fast: SyntoraPHP is optimized for performance, allowing you to build
...
| - Easy: SyntoraPHP follows a user-friendly approach, making it easy for
|   developers to understand and work with the framework.
|
| Key Components:
| - Routing: SyntoraPHP supports routing similar to Laravel, allowing you to
...
| - HTTP Class: SyntoraPHP provides an HTTP class for handling HTTP requests
...
| - Controllers: SyntoraPHP supports controllers, enabling you to organize
